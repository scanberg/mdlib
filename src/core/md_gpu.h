...
md_gpu_buffer_t md_gpu_create_buffer(
...
md_gpu_image_t md_gpu_create_image(
md_gpu_device_t device,
...
Guarantees all prior GPU writes in this command buffer
are visible to all subsequent GPU reads/writes. */
...
md_gpu_fence_t md_gpu_queue_submit(
