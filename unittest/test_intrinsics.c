...
UTEST(intrinsics, test) {
...

    {
        ...
        EXPECT_EQ(bsf32(mask[0]), 0);
        EXPECT_EQ(bsf32(mask[1]), 9);
        EXPECT_EQ(bsf32(mask[2]), 17);
        EXPECT_EQ(bsf32(mask[3]), 25);
        EXPECT_EQ(bsf32(mask[4]), 32);

        EXPECT_EQ(bsr32(mask[0]), 0);
        EXPECT_EQ(bsr32(mask[1]), 9);
        EXPECT_EQ(bsf32(mask[2]), 17);
        EXPECT_EQ(bsf32(mask[3]), 25);
        EXPECT_EQ(bsf32(mask[4]), 32);
    }
