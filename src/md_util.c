...
static const uint32_t element_cpk_colors[] = {
    ...
    RGB(178,  34,  34), // Li (3)       rgb(178, 34, 34)
    ...
    RGB(128, 128, 144), // Ti (22)      rgb(128, 128, 144)
    ...
    RGB(165,  42,  42), // Ni (28)      rgb(165, 42, 42)
    RGB(165,  42,  42), // Cu (29)      rgb(165, 42, 42)
    RGB(165,  42,  42), // Zn (30)      rgb(165, 42, 42)
