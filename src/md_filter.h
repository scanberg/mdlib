...
bool md_filter_evaluate(md_array(struct md_bitfield_t)* bitfields, str_t expression, const struct md_system_t* sys, const struct md_system_state_t* state, const struct md_script_ir_t* ctx_ir, bool* is_dynamic, char* err_buf, size_t err_cap, struct md_allocator_i* alloc);
...
bool md_filter(struct md_bitfield_t* bf, str_t expression, const struct md_system_t* sys, const struct md_system_state_t* state, const struct md_script_ir_t* ctx_ir, bool* is_dynamic, char* err_buf, size_t err_cap);
