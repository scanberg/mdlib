...
//
// md_vlx.c predates this header and still publishes basis/ and the densities itself. The two agree;
// migrating it is a separate change, deliberately not bundled with the readers that introduced this.
