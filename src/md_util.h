...
bool md_util_element_extract(md_element_t element[], int64_t capacity, const struct md_molecule_t* mol);
...
vec3_t md_util_compute_periodic_com(const float* x, const float* y, const float* z, const float* w, int64_t count, vec3_t pbc_ext);
