...
void* md_vm_arena_push(md_vm_arena_t* vm_arena, size_t size);
void* md_vm_arena_push_zero(md_vm_arena_t* vm_arena, size_t size);
void* md_vm_arena_push_aligned(md_vm_arena_t* vm_arena, size_t size, size_t align);
void  md_vm_arena_pop(md_vm_arena_t* vm_arena, size_t size);

void  md_vm_arena_reset(md_vm_arena_t* vm_arena);

void	 md_vm_arena_set_pos(md_vm_arena_t* vm_arena, size_t pos);
size_t md_vm_arena_get_pos(md_vm_arena_t* vm_arena);
