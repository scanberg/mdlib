...
void md_gto_gpu_coeff_upload_density(md_gpu_pass_t pass, md_gpu_buffer_t coeff_buf, md_gpu_buffer_t src_buf, size_t src_offset, size_t num_cgtos);
void md_gto_gpu_coeff_upload_mo(md_gpu_pass_t pass, md_gpu_buffer_t coeff_buf, md_gpu_buffer_t src_buf, size_t src_offset, size_t num_mos, size_t num_cgtos);
