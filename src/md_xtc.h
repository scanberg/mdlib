...
size_t md_xtc_read_frame_offsets_and_times(struct md_file_o* xdr_file, md_array(int64_t)* frame_offsets, md_array(double)* frame_times, struct md_allocator_i* alloc);
...
size_t md_xtc_read_frame_coords_xyz(struct md_file_o* xdr_file, float* out_x, float* out_y, float* out_z, size_t num_atoms);
