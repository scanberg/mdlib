...
MD_SIMD_INLINE md_i32x8_t md_simd_cmp_lt_i32x8(md_i32x8_t a, md_i32x8_t b) {
    md_i32x8_t val = md_simd_not_i32x8(md_simd_cmp_gt_i32x8(a, b));
    return val;
}
...
MD_SIMD_INLINE md_i64x4_t md_simd_cmp_lt_i64x4(md_i64x4_t a, md_i64x4_t b) {
    md_i64x4_t val = md_simd_not_i64x4(md_simd_cmp_gt_i64x4(a, b));
	return val;
}
...
#else
MD_SIMD_INLINE md_f32x4_t md_simd_fmadd_f32x4(md_f32x4_t a, md_f32x4_t b, md_f32x4_t c) { _mm_add_ps(_mm_mul_ps(a,b), c); }
MD_SIMD_INLINE md_f32x8_t md_simd_fmadd_f32x8(md_f32x8_t a, md_f32x8_t b, md_f32x8_t c) { _mm256_add_ps(_mm256_mul_ps(a,b), c); }
MD_SIMD_INLINE md_f64x2_t md_simd_fmadd_f64x2(md_f64x2_t a, md_f64x2_t b, md_f64x2_t c) { _mm_add_pd(_mm_mul_pd(a,b), c); }
MD_SIMD_INLINE md_f64x4_t md_simd_fmadd_f64x4(md_f64x4_t a, md_f64x4_t b, md_f64x4_t c) { _mm256_add_pd(_mm256_mul_pd(a,b), c); }
#endif
